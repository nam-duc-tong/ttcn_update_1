	      ...
	      <div class="section group">
			  ...
			  ?>
				<div class="grid_1_of_4 images_1_of_4" style="width: 270px; height: 400px;">
					 <a href="details.php"><img src="admin/uploads/<?php echo $result['image']?>" alt="" style="width: 80%; height:51%;" /></a>
			...
			<?php
			  ...
			  ?>
				<div class="grid_1_of_4 images_1_of_4"  style="width: 270px; height: 400px;">
					 <a href="details.php"><img src="admin/uploads/<?php echo $result_new['image']?>" alt="" style="width: 80%; height:51%;"  /></a>
